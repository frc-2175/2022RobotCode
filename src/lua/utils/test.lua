...
test("MakePathLine", function(t)
	t:assertEqual(MakePathLine(NewVector(1, 1), NewVector(3.5, 1)),
		{NewVector(1, 1), NewVector(2, 1), NewVector(3, 1), NewVector(3.5, 1)})
	t:assertEqual(MakePathLine(NewVector(1, 1), NewVector(1, 3.5)),
...
test("MakePath", function(t)
   ...
   NewPathSegment(-90, {NewVector(0, 0), NewVector(0, 1), NewVector(0, 2)})})
	...
	t:assertEqual(actualPath,
		{NewVector(0, 0), NewVector(0, 1), NewVector(0, 2), NewVector(0, 2), NewVector(1, 2),
   NewVector(2, 2), NewVector(2, 2), NewVector(2, 3), NewVector(2, 4)})
end)
...
test("DoGrossRampStuff", function(t)
	...
	t:assertEqual(DoGrossRampStuff(0.5, 0.5, 0.2, 0.1), 0.5,
...
test("Vector Tests :D", function(t)
	t:assertEqual(NewVector(1,2)+NewVector(3,4),NewVector(4,6))
	t:assertEqual(NewVector(1,2)+NewVector(3,4),NewVector(-2,-2))
	t:assertEqual(NewVector(1,2)*3,NewVector(3,6))
	t:assertEqual(3*NewVector(1,2),NewVector(3,6))
	t:assertEqual(NewVector(4,6)/2,NewVector(2,3))
	t:assertEqual(-NewVector(1,2),NewVector(-1,-2))
	t:assertEqual(NewVector(3,4) == NewVector (3,4), true)
	t:assertEqual(NewVector(3,4):length(),5)
	t:assertEqual(NewVector(3,4):normalized(),NewVector(0.6,0.8))
	t:assertEqual(NewVector(1,2):rotate(math.pi/2),NewVector(-2,1))
end)
